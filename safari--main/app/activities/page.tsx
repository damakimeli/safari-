export default function ActivitiesPage() {
  const items = [
    { name: "Dawn game drive", note: "Open 4x4, 3–4 hours.", img: "https://loremflickr.com/600/400/gamedrive,safari" },
    { name: "Guided walking safari", note: "Armed guide, 2–3 hours.", img: "https://loremflickr.com/600/400/walkingsafari,africa" },
    { name: "Sundowner walk", note: "Short evening walk, drinks at viewpoint.", img: "https://loremflickr.com/600/400/sunset,savanna" },
    { name: "Village visit", note: "Half-day cultural visit.", img: "https://loremflickr.com/600/400/africanvillage,culture" },
  ];
  return (
