      ...
      <div style={{ maxWidth: "500px", margin: "0 auto" }}>
        ...
        <div style={{ backgroundColor: "#fff", borderRadius: "12px", padding: "2rem" }}>
          ...
          <div style={{ backgroundColor: "#DCEEF2", borderRadius: "8px", padding: "1.5rem", marginBottom: "1.5rem", textAlign: "center" }}>
            <p style={{ fontSize: "0.8rem", color: "#356B67", marginBottom: "0.25rem" }}>Till Number</p>
            <p style={{ fontSize: "1.8rem", color: "#1f3a38", fontWeight: "bold", letterSpacing: "0.05em" }}>9277694</p>
          </div>
          ...
          <ol style={{ color: "#1f3a38", paddingLeft: "1.25rem", marginBottom: "1.5rem", lineHeight: "1.8" }}>
            ...
            <li>Enter Till Number: <strong>9277694</strong></li>
            <li>Enter Amount: <strong>----</strong></li>
            <li>Enter your M-Pesa PIN and confirm</li>
          </ol>

          <p style={{ fontSize: "0.8rem", color: "#356B67", marginBottom: "1.5rem" }}>
            Booking reference: <strong>{booking.id.slice(0, 8)}</strong> — please screenshot or note this for our records.
          </p>
